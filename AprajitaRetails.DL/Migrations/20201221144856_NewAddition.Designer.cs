...
namespace AprajitaRetails.DL.Migrations
{
    ...
    [Migration("20201221144856_NewAddition")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AprajitaRetails.Shared.Models.Sales.DueRecoverd", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Shared.Models.Sales.DuesList", b =>
                {
                    b.Property<int>("DuesListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AprajitaRetails.Shared.Models.Sales.OnlineSale", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Shared.Models.Sales.OnlineSaleReturn", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Shared.Models.Sales.OnlineVendor", b =>
                {
                    b.Property<int>("OnlineVendorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AprajitaRetails.Shared.Models.Sales.DueRecoverd", b =>
                {
                    b.HasOne("AprajitaRetails.Shared.Models.Sales.DuesList", "DuesList")
                        .WithMany("Recoverds")
            ...
            modelBuilder.Entity("AprajitaRetails.Shared.Models.Sales.OnlineSale", b =>
                {
                    b.HasOne("AprajitaRetails.Shared.Models.Sales.OnlineVendor", "Vendor")
            ...
            modelBuilder.Entity("AprajitaRetails.Shared.Models.Sales.OnlineSaleReturn", b =>
                {
                    b.HasOne("AprajitaRetails.Shared.Models.Sales.OnlineSale", "OnlineSale")
                        .WithOne("SaleReturn")
                        .HasForeignKey("AprajitaRetails.Shared.Models.Sales.OnlineSaleReturn", "OnlineSaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
